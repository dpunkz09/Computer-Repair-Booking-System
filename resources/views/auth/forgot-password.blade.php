...
<div class="max-w-md mx-auto bg-white rounded-lg shadow p-8">
    ...
    <p class="text-gray-600 mb-6">Enter your email address and we will send you a password reset link.</p>
    ...
    <p class="text-center mt-4">
        <a href="{{ route('login') }}" class="text-blue-600 hover:text-blue-700 font-bold">Back to login</a>
    </p>
</div>
@endsection
